class World {
  ...
  //object composition for necessary ingame objects 
  ...
  //world constructor adding a keyboard, a drawing canvas and calling several draw methods to start drawing game
  ...
  //pass world objects to other ingame objects (necessary for collision detection etc.)
  setWorld() {
  ...
  /**
   * The following methods serve the purpose of drawing all game objects every x miliseconds within
  ...
  //this method executes all the drawing methods within the specified animation frame  
  drawGame() {
